...
## workaround clang defect temporarily use line below           SDKROOT='/Developer/SDKs/MacOSX10.8.sdk'
...
#
            ...
            LDFLAGS="$LDFLAGS -bundle -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -Xlinker -rpath -Xlinker `pwd`"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
